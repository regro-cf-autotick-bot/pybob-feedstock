...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/pybob-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=13246&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/pybob-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `pybob` can be installed with:

```
conda install pybob
```

It is possible to list all of the versions of `pybob` available on your platform with:
